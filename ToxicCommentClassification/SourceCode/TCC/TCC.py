...
train=pd.read_csv("F:/Projects/Kaggle/ToxicCommentClassification/Data/train.csv")
test=pd.read_csv("F:/Projects/Kaggle/ToxicCommentClassification/Data/test.csv")
print(train.size)
print(train.tail(10))
