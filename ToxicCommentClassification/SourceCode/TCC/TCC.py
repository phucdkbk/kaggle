...
train = pd.read_csv("F:/Projects/Kaggle/kaggle/ToxicCommentClassification/Data/train.csv")
test = pd.read_csv("F:/Projects/Kaggle/kaggle/ToxicCommentClassification/Data/test.csv")
print(train.size)
print(train.tail(10))
...
venn.venn2(subsets=(len(train_ip_list), len(test_ip_list), len(common_ip_list)),
           set_labels=("# of unique IP in train", "# of unique IP in test"))
plt.show()
